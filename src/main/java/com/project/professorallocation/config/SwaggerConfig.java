...
import com.project.professorallocation.ProfessorAllocationCleycianeApplication;
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors
						.basePackage(ProfessorAllocationCleycianeApplication.class.getPackage().getName()))
