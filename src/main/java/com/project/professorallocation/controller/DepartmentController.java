...
public class DepartmentController {
	...
	// curl -v --request POST --header "Content-Type: application/json" --header "Accept: application/json" --data-raw "{\"name\": \"Departamento de Linguística\"}" "http://localhost:8080/departments"
}
